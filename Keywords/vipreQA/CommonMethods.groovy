...
public class CommonMethods {
	...
	@Keyword
	def static void AcceptingQuote(String ReasonWonLost, String DescReason) {
		...
		//WebUI.scrollToElement(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/lbl_Type'), 20)
		WebUI.click(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/Edit_Status'), FailureHandling.STOP_ON_FAILURE)
		WebUI.click(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/drpdown_Draft_Status'), FailureHandling.STOP_ON_FAILURE)
		WebUI.click(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/drpdown_Accepted_Status'), FailureHandling.STOP_ON_FAILURE)
		WebUI.click(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/btn_Save'), FailureHandling.STOP_ON_FAILURE)

		if(WebUI.verifyElementPresent(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/Err_Acc_PrimaryBillingContact'), 20, FailureHandling.OPTIONAL))
		{
			WebUI.click(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/btn_Cancel'), FailureHandling.STOP_ON_FAILURE)
			WebUI.scrollToPosition(0,0)

			//Open Account in a new Tab
			String URL = WebUI.getAttribute(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/link_AccountName'), 'href')
			...
			WebUI.verifyElementPresent(findTestObject('Object Repository/QA Sandbox/Account/Verify_Account_HomePage'), 20, FailureHandling.STOP_ON_FAILURE)
			WebUI.scrollToElement(findTestObject('Object Repository/QA Sandbox/Account/scroll_AccountName'), 20, FailureHandling.STOP_ON_FAILURE)
			WebUI.verifyElementPresent(findTestObject('Object Repository/QA Sandbox/Account/Verify_PrimaryBillingContact'), 20, FailureHandling.STOP_ON_FAILURE)
			WebUI.click(findTestObject('Object Repository/QA Sandbox/Account/Edit_PrimaryBillingContact'), FailureHandling.STOP_ON_FAILURE)
			WebUI.click(findTestObject('Object Repository/QA Sandbox/Account/input_PrimaryBillingContact'), FailureHandling.STOP_ON_FAILURE)
			WebUI.click(findTestObject('Object Repository/QA Sandbox/Account/drpdwn_ContactSelect'), FailureHandling.STOP_ON_FAILURE)
			WebUI.click(findTestObject('Object Repository/QA Sandbox/Account/btn_Save'), FailureHandling.STOP_ON_FAILURE)
			WebUI.verifyElementPresent(findTestObject('Object Repository/QA Sandbox/Account/Verify_Account_HomePage'), 20, FailureHandling.STOP_ON_FAILURE)
		...
		//Verify the error message for Opportunity Reason Won/Lost
		WebUI.verifyElementPresent(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/Err_OpportunityReason'), 20, FailureHandling.STOP_ON_FAILURE)
		WebUI.click(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/btn_Cancel'), FailureHandling.STOP_ON_FAILURE)

		//Add "Reason Won/Lost" and "Description Reason Won/Lost" values on the Quote
		WebUI.verifyElementPresent(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/lbl_ReasonWonLost'),20)

		WebDriver drivers = DriverFactory.getWebDriver()
		WebElement element = WebUiCommonHelper.findWebElement(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/btn_ReasonWonLost'),30)
		JavascriptExecutor executor = ((drivers) as JavascriptExecutor)
		executor.executeScript('arguments[0].click()',element)

		//Entering the Description Reason Won-Lost first
		...
		WebUI.verifyElementPresent(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/lbl_DescReasonWonLost'), 20)

		WebDriver drive = DriverFactory.getWebDriver()
		WebElement elements = WebUiCommonHelper.findWebElement(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/txt_DescWonLost'),30)
		JavascriptExecutor executors = ((drive) as JavascriptExecutor)
		executor.executeScript('arguments[0].click()',elements)

		WebUI.setText(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/txt_DescWonLost'), ReasonWonLost)

		//Selecting the value for Reason Won-Lost
		WebUI.scrollToElement(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/lbl_PipelineCommentary'), 20, FailureHandling.STOP_ON_FAILURE)
		WebUI.click(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/Select_ReasonWonLost',[('value') : ReasonWonLost]))
		WebUI.click(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/btn_MoveToChosen'))
		WebUI.click(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/btn_MoveToChosen'))

		WebDriver driv = DriverFactory.getWebDriver()
		WebElement elem = WebUiCommonHelper.findWebElement(findTestObject('Object Repository/QA Sandbox/Quote/Quote_DetailsTab/btn_Save_OppReason'),30)
		JavascriptExecutor execut = ((driv) as JavascriptExecutor)
		...
		//Verifying the Status field for the Accepted Value
		String Status = WebUI.getText(findTestObject('Object Repository/QA Sandbox/DirectQuote_Creation/Verify_Status'))
		println('Status:'+Status)
